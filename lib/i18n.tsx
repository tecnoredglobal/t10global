...
export const translations = {
  en: {
    ...
    'chat.title': 'T10Global Assistant',
    'chat.welcome': "Hi, I'm the T10Global assistant. How can I help you with our services?",
    'chat.placeholder': 'Ask about our services…',
    'chat.limit': 'Session limit reached.',
    'chat.limit.email': 'Email us directly',
    'chat.error': 'Connection error. Please email info@t10global.com.',
  ...
  es: {
    ...
    'footer.legal.cookies': 'Cookies',
    'chat.title': 'Asistente T10Global',
    'chat.welcome': 'Hola, soy el asistente de T10Global. ¿En qué puedo ayudarte sobre nuestros servicios?',
    'chat.placeholder': 'Consulta sobre nuestros servicios…',
    'chat.limit': 'Límite de sesión alcanzado.',
    'chat.limit.email': 'Escríbenos directamente',
    'chat.error': 'Error de conexión. Por favor escribe a info@t10global.com.',
